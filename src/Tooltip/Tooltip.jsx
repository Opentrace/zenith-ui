...
class Tooltip extends React.Component {
  ...
  componentDidMount() {
    ...
    tooltipContentEl.textContent = this.props.text;
  ...
  componentDidUpdate() {
    this.tooltipEl.className = 'tooltip ' + this.props.position;
    this.tooltipEl.childNodes[1].textContent = this.props.text;
  }
  ...
  render() {
    return (
      <span>
        <Style
          scopeSelector={ `.tooltip.${ this.props.position }` }
          rules={ Object.assign(Styles.base, Styles[this.props.position]) } />
        { this.props.children }
      </span>
    )
  }
